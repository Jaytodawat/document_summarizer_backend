...
public class AppConstants {
    ...
    public static final String[] PRIVATE_URLS = {"/api/paper_summarizer/upload", "/api/paper_summarizer/download", "/api/paper_summarizer/files", "api/paper_summarizer/prompt"};
